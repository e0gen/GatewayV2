...
namespace Ezzygate.Infrastructure.Tests.Configuration.Json;
...
public class JsonConfigurationExtensionsTests
{
    ...
    private IConfiguration BuildConfiguration()
    {
        return new ConfigurationBuilder()
            .AddJsonInfrastructureConfigurationSource(_testConfigPath)
            .Build();
    }
    ...
    [Test]
    public void AddJsonInfrastructureConfigurationSource_FileNotFound_ThrowsFileNotFoundException()
    {
        var builder = new ConfigurationBuilder();
        var nonExistentPath = Path.Combine(TestContext.CurrentContext.TestDirectory, "NonExistent");

        Assert.Throws<FileNotFoundException>(() => builder.AddJsonInfrastructureConfigurationSource(nonExistentPath));
    }

    [Test]
    public void AddJsonInfrastructureConfigurationSource_ValidFile_BuildsConfiguration()
    {
        var configuration = BuildConfiguration();
    ...
    public void Configure_ApplicationConfiguration_BindsAllApplicationProperties()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(config.IsErrorNetConnectionStringEncrypted, Is.False);
